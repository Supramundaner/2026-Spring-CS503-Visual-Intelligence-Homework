...
class FourM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dec_context_proj = nn.Linear(dim, dim, bias=False) # TODO: Define the encoder -> decoder projection. This is simply a linear layer mapping dim -> dim.
    ...
    def generate_one_modality_roar(
        ...
        dec_input_positions_list = list(shuffled_positions.split(schedule))
